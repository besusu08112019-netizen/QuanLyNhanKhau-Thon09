(() => {
  ...
  async function handleBusinessGpsAction(action) {
    ...
    if (action === 'map') {
      ...
      if (typeof window.switchScreen === 'function') window.switchScreen('gisGoogle');
    ...
    if (action === 'geocode') {
      ...
      if (address) window.open('https://www.google.com/maps/search/?api=1&query=' + encodeURIComponent(address), '_blank', 'noopener');
      show('\u0110\u00e3 m\u1edf Google Maps theo \u0111\u1ecba ch\u1ec9. \u0110\u1ec3 l\u01b0u t\u1ecda \u0111\u1ed9, h\u00e3y \u0111\u1ecbnh v\u1ecb h\u1ed9 trong module GIS.', 'info');
    }
  }
