(function () {
  ...
  function fitPopulationNames() {
    ...
    document.querySelectorAll('#personsScreen #personRows .population-card-name').forEach(function (name) {
      ...
      var minSize = window.innerWidth < 360 ? 11 : 12;
      var guard = 0;
...
@media (max-width:1199px){
  ...
  #personsScreen #personRows .person-household-group-card{display:flex!important;align-items:center!important;justify-content:space-between!important;gap:10px!important;padding:9px 12px!important;border:1px solid #d9f1e4!important;border-radius:12px!important;background:#f6fcf9!important;color:#0f5132!important}#personsScreen #personRows .person-household-group-main{min-width:0!important;display:flex!important;align-items:center!important;gap:9px!important}#personsScreen #personRows .person-household-group-icon{width:28px!important;height:28px!important;border-radius:9px!important;font-size:13px!important;background:#e4f6ec!important;color:#0a8f4d!important}#personsScreen #personRows .person-household-group-main strong{font-size:13px!important;line-height:1.2!important}#personsScreen #personRows .person-household-group-main small{font-size:11px!important;line-height:1.2!important}#personsScreen #personRows .person-household-group-count{min-height:24px!important;padding:3px 8px!important;font-size:11px!important;white-space:nowrap!important}
  #personsScreen #personRows .population-row{margin:0 0 18px!important;border:0!important;background:transparent!important}#personsScreen #personRows .population-card,#personsScreen #personRows .population-card *{box-sizing:border-box!important}#personsScreen #personRows .population-card{display:grid!important;width:100%!important;max-width:100%!important;overflow:hidden!important;gap:10px!important;padding:14px!important;border:1px solid #dfe7e2!important;border-radius:18px!important;background:#fff!important;box-shadow:0 10px 24px rgba(15,23,42,.06)!important}
  #personsScreen #personRows .population-card-head{display:grid!important;grid-template-columns:minmax(0,1fr) auto!important;align-items:center!important;gap:8px!important;padding-bottom:8px!important;border-bottom:1px solid #edf2ef!important}#personsScreen #personRows .population-card-title-stack{min-width:0!important;display:grid!important;gap:5px!important;overflow:hidden!important}#personsScreen #personRows .population-card-name{display:block!important;width:100%!important;max-width:100%!important;min-width:0!important;padding:0!important;border:0!important;background:transparent!important;text-align:left!important;text-transform:uppercase!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:clip!important;word-break:normal!important;overflow-wrap:normal!important;color:#06733f!important;font-size:clamp(15px,5.4vw,28px)!important;line-height:1.16!important;font-weight:800!important;letter-spacing:0!important}#personsScreen #personRows .population-relation-badge{width:fit-content!important;max-width:100%!important;display:inline-flex!important;align-items:center!important;gap:5px!important;min-height:23px!important;padding:3px 8px!important;border-radius:999px!important;border:1px solid #d9eadf!important;background:#f4faf6!important;color:#0f5132!important;font-size:clamp(10px,2.8vw,12px)!important;font-weight:800!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}
  #personsScreen #personRows .population-card-head-actions{display:grid!important;grid-template-columns:auto auto!important;align-items:center!important;justify-content:end!important;gap:7px!important;min-width:0!important}#personsScreen #personRows .population-household-badge{width:auto!important;max-width:34vw!important;min-width:0!important;height:clamp(30px,7vw,38px)!important;min-height:clamp(30px,7vw,38px)!important;padding:0 clamp(7px,2vw,10px)!important;border:1px solid #bfe8cf!important;border-radius:999px!important;background:#eaf8f0!important;color:#1f2937!important;font-size:clamp(13px,3.9vw,18px)!important;line-height:1!important;font-weight:800!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}#personsScreen #personRows .population-check{align-self:center!important;justify-self:end!important;width:clamp(20px,5vw,24px)!important;height:clamp(20px,5vw,24px)!important;margin:0!important;accent-color:#0a8f4d!important}
  #personsScreen #personRows .population-code-grid,#personsScreen #personRows .population-bio-grid,#personsScreen #personRows .population-context-grid{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:8px!important;width:100%!important;overflow:hidden!important}.population-code-box,.population-detail-box{min-width:0!important;width:100%!important;overflow:hidden!important;border:1px solid #edf1ef!important;border-radius:14px!important;background:#fff!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.65)!important}.population-code-box{min-height:54px!important;padding:8px 10px!important;display:grid!important;grid-template-columns:1fr!important;align-content:center!important;gap:3px!important}.population-code-box span,.population-detail-label{min-width:0!important;color:#667085!important;font-size:clamp(10px,2.8vw,13px)!important;line-height:1.15!important;font-weight:800!important}.population-code-box strong,.population-detail-value{min-width:0!important;color:#17352d!important;font-size:clamp(13px,3.8vw,18px)!important;line-height:1.18!important;font-weight:800!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important;word-break:keep-all!important}.population-detail-box{min-height:66px!important;padding:8px 10px!important;display:grid!important;grid-template-columns:auto minmax(0,1fr)!important;align-items:center!important;gap:9px!important}.population-detail-copy{min-width:0!important;display:grid!important;gap:2px!important}.population-birth-age{display:block!important;min-width:0!important;color:#0f5132!important;font-size:clamp(10px,2.9vw,13px)!important;line-height:1.15!important;font-weight:800!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}.population-card-icon{flex:0 0 auto!important;font-size:clamp(17px,4vw,22px)!important}.population-card-icon-date,.population-card-icon-home{color:#0a8f4d!important}.population-card-icon-age{color:#d97706!important}.population-card-icon-female{color:#e11d48!important}.population-card-icon-male{color:#2563eb!important}
  #personsScreen #personRows .population-admin-grid{display:grid!important;grid-template-columns:1fr!important;gap:8px!important}.population-status-card{min-height:54px!important;background:#f8fbf9!important}.population-status-pill{display:inline-flex!important;align-items:center!important;justify-content:center!important;width:fit-content!important;max-width:100%!important;min-height:27px!important;padding:5px 13px!important;border-radius:999px!important;font-style:normal!important;font-weight:800!important;font-size:clamp(12px,3vw,15px)!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}.population-status-pill.population-status-home{background:#dcfce7!important;color:#15803d!important;border:1px solid #bbf7d0!important}.population-status-pill.population-status-temp{background:#fef3c7!important;color:#b45309!important;border:1px solid #fde68a!important}.population-status-pill.population-status-away{background:#ffedd5!important;color:#c2410c!important;border:1px solid #fed7aa!important}.population-status-pill.population-status-muted{background:#f1f5f9!important;color:#475569!important;border:1px solid #e2e8f0!important}.population-party-yes{background:#eefaf3!important;border-color:#bfead2!important}.population-party-no{background:#f8fafc!important;border-color:#e5e7eb!important}
