...
gisDisableActiveDraw();
if (App.gis.drawnLayer && App.gis.drawnLayer !== layer && App.gis.layerGroup.hasLayer(App.gis.drawnLayer)) App.gis.layerGroup.removeLayer(App.gis.drawnLayer);
App.gis.drawnLayer = layer;
...
if (layer.setStyle) layer.setStyle({ color, fillColor: color, fillOpacity: .2, weight: 2 });
attachGisAreaEditEvents(layer);
gisMarkAreaDirty(true);
}
