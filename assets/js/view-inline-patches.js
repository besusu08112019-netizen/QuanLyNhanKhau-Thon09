...
function lockReportTypes(){var select=q('#reportTypeSelect');if(!select)return;var value=select.value||'summary';var options=[['summary','Báo cáo tổng hợp'],['population','Báo cáo nhân khẩu'],['household','Báo cáo hộ gia đình'],['public-assets','Công trình công cộng - Danh sách'],['public-assets-located','Công trình công cộng - Đã có GPS'],['public-assets-missing-gps','Công trình công cộng - Chưa có GPS'],['public-assets-inventory','Công trình công cộng - Kiểm kê tài sản'],['houses','Nhà ở và công trình - Danh sách'],['houses-degraded','Nhà ở xuống cấp'],['houses-temporary','Nhà tạm'],['houses-fire-risk','Nhà nguy cơ PCCC'],['houses-missing-gps','Nhà chưa có GPS'],['household-business-production','Hộ sản xuất'],['household-business-trade','Hộ kinh doanh'],['household-business-sector','Hộ SXKD theo ngành nghề'],['household-business-status','Hộ SXKD theo trạng thái'],['agriculture','Sản xuất nông nghiệp - Danh sách'],['agriculture-producers','Chủ thể sản xuất nông nghiệp'],['agriculture-area','Diện tích sản xuất nông nghiệp'],['agriculture-crop','Cây trồng'],['agriculture-season','Mùa vụ'],['agriculture-production','Sản lượng nông nghiệp'],['agriculture-damage','Thiệt hại nông nghiệp'],['livestock','Vật nuôi - Danh sách'],['livestock-by-type','Vật nuôi theo loại'],['livestock-vaccinated','Vật nuôi đã tiêm phòng'],['livestock-unvaccinated','Vật nuôi chưa tiêm phòng'],['livestock-disease','Vật nuôi có dịch bệnh'],['vehicles','Xe cộ - Danh sách'],['vehicles-by-type','Xe cộ theo loại'],['vehicles-missing-plate','Xe chưa có biển số'],['vehicles-expired-inspection','Xe hết hạn kiểm định'],['vehicles-expired-insurance','Xe hết hạn bảo hiểm'],['contributions-list','Đóng góp hộ - Danh sách'],['contributions-collection','Đóng góp hộ - Thu tiền'],['contributions-unpaid-list','Đóng góp hộ - Chưa nộp'],['contributions-partial','Đóng góp hộ - Nộp một phần'],['contributions-exempt','Đóng góp hộ - Miễn giảm'],['contributions-summary','Đóng góp hộ - Tổng hợp'],['contributions-year-summary','Đóng góp hộ - Tổng hợp năm'],['contributions-by-contribution','Đóng góp hộ - Theo khoản thu'],['gis','GIS - Hộ gia đình'],['gis-located','GIS - Đã định vị'],['gis-unlocated','GIS - Chưa định vị'],['digital-profile','Hồ sơ số'],['profile-complete','Hồ sơ hoàn chỉnh'],['profile-missing-photo','Hồ sơ thiếu ảnh'],['profile-missing-documents','Hồ sơ thiếu giấy tờ'],['profile-incomplete','Hồ sơ chưa hoàn thiện'],['temporary_residence','Báo cáo tạm trú'],['temporary_absence','Báo cáo tạm vắng'],['migration','Báo cáo biến động'],['health_insurance','Báo cáo Bảo hiểm y tế'],['health-insurance-missing','Danh sách chưa tham gia BHYT'],['health-insurance-expiring','Danh sách BHYT sắp hết hạn (30 ngày)'],['health-insurance-expired','Danh sách BHYT đã hết hạn'],['health-insurance-household','Thống kê BHYT theo hộ'],['health-insurance-area','Thống kê BHYT theo khu vực'],['party_member','Báo cáo Đảng viên'],['meritorious_person','Báo cáo người có công'],['disabled_person','Báo cáo người khuyết tật'],['age','Báo cáo theo độ tuổi'],['gender','Báo cáo theo giới tính'],['youth_union_member','Báo cáo Đoàn viên'],['poor-households','Báo cáo hộ nghèo'],['near-poor-households','Báo cáo hộ cận nghèo'],['labor','Báo cáo lao động'],['elderly','Báo cáo người cao tuổi'],['children','Báo cáo trẻ em']];var html=options.map(function(item){return '<option value="'+item[0]+'">'+item[1]+'</option>';}).join('');if(select.innerHTML.replace(/\s+/g,' ').trim()!==html.replace(/\s+/g,' ').trim())select.innerHTML=html;if(!Array.prototype.some.call(select.options,function(o){return o.value===value;}))value='summary';select.value=value;}
