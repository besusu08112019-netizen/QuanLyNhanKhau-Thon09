...
<body>
  ...
  <div id="appView" class="app-shell d-none">
    ...
    <aside class="sidebar gov-sidebar">
      ...
      <nav class="nav flex-column gov-nav" aria-label="Điều hướng chính">
        <div class="nav-section dashboard-tree" data-dashboard-tree><button class="dashboard-tree-toggle" type="button" aria-expanded="false" data-dashboard-toggle><i class="fa-solid fa-gauge-high"></i><span>Dashboard</span><b class="dashboard-tree-caret" aria-hidden="true">&#9656;</b></button><div class="dashboard-tree-children" data-dashboard-children><button class="nav-link dashboard-tree-link active" data-screen="dashboard" onclick="window.switchScreen && window.switchScreen(this.dataset.screen)"><i class="fa-solid fa-chart-line"></i><span>T&#7893;ng quan</span></button><button class="nav-link dashboard-tree-link" data-screen="dashboardHouseholds" onclick="window.switchScreen && window.switchScreen(this.dataset.screen)"><i class="fa-solid fa-house-chimney"></i><span>H&#7897; d&#226;n</span></button><button class="nav-link dashboard-tree-link" data-screen="dashboardPopulation" onclick="window.switchScreen && window.switchScreen(this.dataset.screen)"><i class="fa-solid fa-users"></i><span>Nh&#226;n kh&#7849;u</span></button><button class="nav-link dashboard-tree-link" data-screen="dashboardBusiness" onclick="window.switchScreen && window.switchScreen(this.dataset.screen)"><i class="fa-solid fa-store"></i><span>Kinh doanh</span></button><button class="nav-link dashboard-tree-link" data-screen="dashboardVehicles" onclick="window.switchScreen && window.switchScreen(this.dataset.screen)"><i class="fa-solid fa-car"></i><span>Xe c&#7897;</span></button><button class="nav-link dashboard-tree-link" data-screen="dashboardLivestock" onclick="window.switchScreen && window.switchScreen(this.dataset.screen)"><i class="fa-solid fa-paw"></i><span>V&#7853;t nu&#244;i</span></button><button class="nav-link dashboard-tree-link" data-screen="dashboardGis" onclick="window.switchScreen && window.switchScreen(this.dataset.screen)"><i class="fa-solid fa-map-location-dot"></i><span>GIS</span></button><button class="nav-link dashboard-tree-link" data-screen="dashboardReports" onclick="window.switchScreen && window.switchScreen(this.dataset.screen)"><i class="fa-solid fa-file-lines"></i><span>B&#225;o c&#225;o</span></button></div></div><div class="nav-section"><div class="nav-section-title">T&#7893;ng quan</div><button class="nav-link" data-screen="operationCenter" onclick="window.switchScreen && window.switchScreen(this.dataset.screen)"><i class="fa-solid fa-tower-broadcast"></i><span>Trung tâm điều hành</span></button><button class="nav-link" data-screen="gis" onclick="window.switchScreen && window.switchScreen(this.dataset.screen)"><i class="fa-solid fa-map-location-dot"></i><span>Bản đồ địa bàn</span></button></div><div class="nav-section"><div class="nav-section-title">Quản lý dân cư</div><button class="nav-link" data-screen="households" onclick="window.switchScreen && window.switchScreen(this.dataset.screen)"><i class="fa-solid fa-house-chimney"></i><span>Quản lý hộ gia đình</span></button><button class="nav-link" data-screen="businessHouseholds" onclick="window.switchScreen && window.switchScreen(this.dataset.screen)"><i class="fa-solid fa-store"></i><span>Hộ sản xuất &amp; kinh doanh</span></button><button class="nav-link" data-screen="vehicles" onclick="window.switchScreen && window.switchScreen(this.dataset.screen)"><i class="fa-solid fa-car"></i><span>Qu&#7843;n l&#253; xe c&#7897;</span></button><button class="nav-link" data-screen="contributions" onclick="window.switchScreen && window.switchScreen(this.dataset.screen)"><i class="fa-solid fa-hand-holding-dollar"></i><span>&#272;&#243;ng g&#243;p h&#7897;</span></button><button class="nav-link" data-screen="agriculture" onclick="window.switchScreen && window.switchScreen(this.dataset.screen)"><i class="fa-solid fa-seedling"></i><span>S&#7843;n xu&#7845;t n&#244;ng nghi&#7879;p</span></button><button class="nav-link" data-screen="houses" onclick="window.switchScreen && window.switchScreen(this.dataset.screen)"><i class="fa-solid fa-building-user"></i><span>Nh&#224; &#7903; &amp; C&#244;ng tr&#236;nh</span></button><button class="nav-link" data-screen="publicAssets" onclick="window.switchScreen && window.switchScreen(this.dataset.screen)"><i class="fa-solid fa-building-columns"></i><span>C&#244;ng tr&#236;nh c&#244;ng c&#7897;ng</span></button><button class="nav-link" data-screen="livestock" onclick="window.switchScreen && window.switchScreen(this.dataset.screen)"><i class="fa-solid fa-paw"></i><span>Quản lý vật nuôi</span></button><button class="nav-link" data-screen="persons" onclick="window.switchScreen && window.switchScreen(this.dataset.screen)"><i class="fa-solid fa-users"></i><span>Quản lý nhân khẩu</span></button><button class="nav-link" data-screen="temporaryResidence" onclick="window.switchScreen && window.switchScreen(this.dataset.screen)"><i class="fa-solid fa-location-dot"></i><span>Tạm trú</span></button><button class="nav-link" data-screen="temporaryAbsence" onclick="window.switchScreen && window.switchScreen(this.dataset.screen)"><i class="fa-solid fa-person-walking-arrow-right"></i><span>Tạm vắng</span></button><button class="nav-link" data-screen="movements" onclick="window.switchScreen && window.switchScreen(this.dataset.screen)"><i class="fa-solid fa-right-left"></i><span>Biến động nhân khẩu</span></button></div>
    ...
    <section class="main-area">
      ...
      <section id="vehiclesScreen" class="screen household-management-screen module-placeholder-screen vehicles-screen">
        <div class="content-card module-filter-card ds-module-shell">
          ...
          <div class="module-placeholder-actions"><button class="btn btn-primary" type="button" onclick="window.switchScreen && window.switchScreen('dashboardVehicles')"><i class="fa-solid fa-chart-simple"></i> M&#7903; Dashboard Xe c&#7897;</button></div>
        </div>
      </section>
      ...
      <section id="contributionsScreen" class="screen household-management-screen module-placeholder-screen contributions-screen">
        <div class="content-card module-filter-card ds-module-shell">
          ...
          <div class="module-placeholder-actions"><button class="btn btn-outline-primary" type="button" onclick="window.switchScreen && window.switchScreen('reports')"><i class="fa-solid fa-chart-pie"></i> M&#7903; B&#225;o c&#225;o</button></div>
        </div>
      </section>
      ...
      <section id="publicAssetsScreen" class="screen household-management-screen public-assets-screen">
        ...
        <section class="agri-filter-card" aria-label="B&#7897; l&#7885;c c&#244;ng tr&#236;nh c&#244;ng c&#7897;ng">
          <div class="agri-filter-row">
            ...
            <div class="agri-filter-actions"><button id="publicAssetsSearchBtn" class="btn btn-primary" type="button"><i class="fa-solid fa-magnifying-glass"></i> T&#236;m</button><button id="publicAssetsResetBtn" class="btn btn-outline-secondary" type="button"><i class="fa-solid fa-rotate-right"></i> &#272;&#7863;t l&#7841;i</button></div>
          </div>
        </section>
        ...
        <div class="module-list-card household-list-card agri-table-card"><div class="module-list-head"><div><h3>Danh s&#225;ch c&#244;ng tr&#236;nh c&#244;ng c&#7897;ng</h3><span id="publicAssetsTotalCount">T&#7893;ng s&#7889;: 0 c&#244;ng tr&#236;nh</span></div></div><div class="table-responsive"><table class="table module-table agri-data-table align-middle mb-0"><thead><tr><th>STT</th><th>&#7842;nh</th><th data-public-asset-sort="asset_code">M&#227; c&#244;ng tr&#236;nh</th><th data-public-asset-sort="asset_name">T&#234;n c&#244;ng tr&#236;nh</th><th data-public-asset-sort="type_name">Lo&#7841;i</th><th data-public-asset-sort="area_code">Khu v&#7921;c</th><th data-public-asset-sort="campus_area">Di&#7879;n t&#237;ch</th><th data-public-asset-sort="manager_name">&#272;&#417;n v&#7883;/Ng&#432;&#7901;i qu&#7843;n l&#253;</th><th data-public-asset-sort="status">Tr&#7841;ng th&#225;i</th><th class="text-end">Thao t&#225;c</th></tr></thead><tbody id="publicAssetsRows"></tbody></table></div><div id="publicAssetsPager" class="pager module-pager"></div></div>
      </section>
  ...
  <script src="assets/js/public-assets.min.js"></script>
