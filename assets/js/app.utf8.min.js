...
return '<button class="btn btn-sm btn-primary" type="button" data-platform-action="households.detail" data-id="' + id + '"><i class="fa-solid fa-folder-open"></i> Chi ti\u1ebft h\u1ed9</button>';
}
