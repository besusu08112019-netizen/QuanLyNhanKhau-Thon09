(function () {
  ...
  const state = { page: 1, pageSize: 20, search: '', category_id: '', priority_id: '', status_id: '', assigned_user_id: '', receiver_user_id: '', household_id: '', area_code: '', date_from: '', date_to: '', overdue: '', sort: 'received_at', direction: 'DESC', catalogs: null, current: null };
