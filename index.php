...
$html = preg_replace('/<\/body>/', '<script src="assets/js/mobile-design-system.js?v=20260701-mobile-ds-2"></script>' . "\n</body>", $html, 1);
echo $html;