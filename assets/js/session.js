(() => {
  ...
  function loadFinalMobilePersonCards() {
    const run = async () => {
      try {
        await loadScriptOnce('assets/js/mobile-design-system.js?v=20260702-desktop-person-aligner-1', 'thon09-mobile-design-system');
        ...
        await loadScriptOnce('assets/js/person-desktop-column-aligner.js?v=20260702-desktop-person-aligner-1', 'thon09-person-desktop-column-aligner');
