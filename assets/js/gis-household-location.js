  ...
  function useGps(householdId, triggerButton) {
    ...
    const saveBest = async () => {
      ...
      try {
        ...
        if (typeof window.thon09GisFocusHouseholdMarker === 'function') {
          window.thon09GisFocusHouseholdMarker(Object.assign({}, row, { id: householdId, latitude: lat, longitude: lng }));
        }
