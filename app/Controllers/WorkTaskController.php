...
final class WorkTaskController extends BaseController
{
    ...
    private function filters(): array
    {
        return [
            ...
            'related_module' => $this->query('related_module', $this->query('relatedModule', '')),
            'related_id' => $this->query('related_id', $this->query('relatedId', '')),
            'source_ref' => $this->query('source_ref', $this->query('sourceRef', '')),
