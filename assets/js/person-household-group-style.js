(function () {
  ...
  function mobileCard(row, residence, party) {
    ...
    var adminDetails = detailBox('<i class="fa-solid fa-users population-card-icon-age"></i>', 'Đảng viên', party ? 'Có' : 'Không', '', party ? 'population-party-yes' : 'population-party-no')
      + detailBox('<i class="fa-solid fa-place-of-worship population-card-icon-muted"></i>', 'Tôn giáo', firstValue(row, ['religion', 'religion_name']), '', 'population-optional-detail')
      + detailBox('<i class="fa-solid fa-globe population-card-icon-muted"></i>', 'Quốc tịch', firstValue(row, ['nationality', 'country']), '', 'population-optional-detail')
      + detailBox('<i class="fa-solid fa-graduation-cap population-card-icon-muted"></i>', 'Trình độ', firstValue(row, ['education_level', 'education', 'academic_level']), '', 'population-optional-detail')
      + detailBox('<i class="fa-solid fa-briefcase population-card-icon-muted"></i>', 'Nghề nghiệp', firstValue(row, ['occupation', 'job', 'career']), '', 'population-optional-detail');
