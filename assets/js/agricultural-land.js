(function () {
  ...
  async function openDetail(id) {
    ...
    const fields = [
      ...
      ['Đất giao đã chuyển đổi cơ cấu sản xuất', area(row.converted_area, row.unit)],
      ['Ghi chú nghiệp vụ', 'Đất chuyển đổi nằm trong đất giao dài hạn, không phải quỹ đất phát sinh thêm.'],
      ...usage,
