(function () {
  ...
  async function mark(id, status) {
    ...
    toast(status === 'processed' ? 'ÄÃ£ Ä‘Ã¡nh dáº¥u xá»­ lÃ½' : 'ÄÃ£ Ä‘Ã¡nh dáº¥u rÃ  soÃ¡t', 'success');
