...
final class Encoding
{
    ...
    public static function isBetterRepair(string $source, string $candidate): bool
    {
        ...
        if (preg_match('/[Ã¢ÄƒÃªÃ´Æ¡Æ°Ã‚Ä‚ÃŠÃ”Æ Æ¯][Ì€ÌÌ‰ÌƒÌ£Ã Ã¡áº£Ã£áº¡áº§áº¥áº©áº«áº­áº±áº¯áº³áºµáº·Ã¨Ã©áº»áº½áº¹á»áº¿á»ƒá»…á»‡Ã¬Ã­á»‰Ä©á»‹Ã²Ã³á»Ãµá»á»“á»‘á»•á»—á»™á»á»›á»Ÿá»¡á»£Ã¹Ãºá»§Å©á»¥á»«á»©á»­á»¯á»±á»³Ã½á»·á»¹á»µ]/u', $candidate) === 1) {
            return false;
        }
        ...
        return preg_match('/[Ã€-á»¹ÄÄ‘]/u', $candidate) === 1 || $candidateScore === 0;
    }
