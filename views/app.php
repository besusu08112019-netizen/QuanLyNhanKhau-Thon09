...
<body>
  ...
  <div class="modal fade" id="businessHouseholdModal" tabindex="-1" aria-hidden="true"><div class="modal-dialog modal-xl modal-dialog-scrollable"><form class="modal-content" id="businessHouseholdForm"><div class="modal-header"><h5 class="modal-title">Thông tin hộ sản xuất &amp; kinh doanh</h5><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Đóng"></button></div><div class="modal-body"><input type="hidden" name="id"><div class="row g-3"><div class="col-md-4"><label class="form-label">Hộ gia đình</label><select name="household_id" class="form-select" required id="businessHouseholdSelect"></select></div><div class="col-md-4"><label class="form-label">Tên cơ sở</label><input name="business_name" class="form-control"></div><div class="col-md-4"><label class="form-label">Chủ cơ sở</label><input name="owner_name" class="form-control"></div><div class="col-md-4"><label class="form-label">Loại hình</label><select name="business_type" class="form-select" required><option value="RESIDENT">Hộ dân</option><option value="PRODUCTION">Hộ sản xuất</option><option value="BUSINESS">Hộ kinh doanh</option><option value="BOTH">Hộ sản xuất và kinh doanh</option></select></div><div class="col-md-4"><label class="form-label">Ngành sản xuất</label><input name="production_sector" class="form-control"></div><div class="col-md-4"><label class="form-label">Ngành kinh doanh</label><input name="business_sector" class="form-control"></div><div class="col-md-4"><label class="form-label">Ngày bắt đầu hoạt động</label><input name="start_date" type="date" class="form-control"></div><div class="col-md-4"><label class="form-label">Số giấy phép</label><input name="business_license" class="form-control"></div><div class="col-md-4"><label class="form-label">Ngày cấp</label><input name="license_date" type="date" class="form-control"></div><div class="col-md-4"><label class="form-label">Nơi cấp</label><input name="license_place" class="form-control"></div><div class="col-md-4"><label class="form-label">Mã số thuế</label><input name="tax_code" class="form-control"></div><div class="col-md-4"><label class="form-label">Số lao động</label><input name="worker_count" type="number" min="0" class="form-control" value="0"></div><div class="col-md-4"><label class="form-label">Doanh thu năm</label><input name="annual_revenue" type="number" min="0" step="1000" class="form-control"></div><div class="col-md-4"><label class="form-label">Điện thoại</label><input name="phone" class="form-control"></div><div class="col-md-4"><label class="form-label">Email</label><input name="email" type="email" class="form-control"></div><div class="col-12"><label class="form-label">Địa chỉ</label><input name="address" class="form-control"></div><div class="col-md-4"><label class="form-label">Vĩ độ GPS</label><input name="latitude" class="form-control" inputmode="decimal"></div><div class="col-md-4"><label class="form-label">Kinh độ GPS</label><input name="longitude" class="form-control" inputmode="decimal"></div><div class="col-md-4"><label class="form-label">Trạng thái</label><select name="status" class="form-select"><option value="ACTIVE">Đang hoạt động</option><option value="INACTIVE">Ngừng hoạt động</option><option value="SUSPENDED">Tạm ngừng</option></select></div><div class="col-12"><label class="form-label">Ghi chú</label><textarea name="note" class="form-control" rows="2"></textarea></div></div></div><div class="modal-footer"><button type="button" class="btn btn-light" data-bs-dismiss="modal">Hủy</button><button type="submit" class="btn btn-primary">Lưu</button></div></form></div></div>
