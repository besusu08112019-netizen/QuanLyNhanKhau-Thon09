...
async function ensureGisAssets() {
  await Promise.all([
    ...
    loadStyleOnce('https://cdn.jsdelivr.net/npm/leaflet.markercluster@1.5.3/dist/MarkerCluster.css'),
    loadStyleOnce('https://cdn.jsdelivr.net/npm/leaflet.markercluster@1.5.3/dist/MarkerCluster.Default.css'),
    loadScriptOnce('https://cdn.jsdelivr.net/npm/leaflet@1.9.4/dist/leaflet.js', () => Boolean(window.L))
  ]);
  await Promise.all([
    loadScriptOnce('https://cdn.jsdelivr.net/npm/leaflet-draw@1.0.4/dist/leaflet.draw.js', () => Boolean(window.L?.Draw)),
    loadScriptOnce('https://cdn.jsdelivr.net/npm/leaflet.markercluster@1.5.3/dist/leaflet.markercluster.js', () => Boolean(window.L?.markerClusterGroup))
  ]);
}
