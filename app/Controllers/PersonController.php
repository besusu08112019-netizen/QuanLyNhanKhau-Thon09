...
final class PersonController extends BaseController
{
    ...
    public function index(): void
    {
        ...
        $this->ok($this->citizens->page(['page' => $this->query('page', 1), 'pageSize' => $this->query('pageSize', 20), 'search' => $this->query('search', $this->query('q', '')), 'status' => $this->query('status', ''), 'presenceStatus' => $this->query('presenceStatus', ''), 'householdId' => $this->query('householdId', $this->query('householdCode', ''))]));
    }
