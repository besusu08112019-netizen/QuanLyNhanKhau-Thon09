const PWA_VERSION = 'tenant-pwa-v20260726-ai-release-1';
...
const STATIC_ASSETS = [
  ...
  withBase('assets/js/ai-speech.min.js'),
  withBase('assets/js/ai-intent.min.js'),
  withBase('assets/js/ai-conversation.min.js'),
  withBase('assets/js/ai-ocr.min.js'),
  withBase('assets/js/ai-tts.min.js'),
