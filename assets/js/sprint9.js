(() => {
  ...
  if (typeof oldShowApp === 'function') {
    window.showApp = function sprint9ShowApp() { oldShowApp(); bootSprint9(); };
  }
  ...
  function patchImportScreen() {
    ...
    if (!screen || screen.dataset.sprint9) return;
