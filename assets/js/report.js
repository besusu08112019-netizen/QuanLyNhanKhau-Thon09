(() => {
  ...
  function ensureReportTypes() {
    ...
    const types = [
      ...
      ['health_insurance', 'Thống kê Bảo hiểm y tế'], ['health-insurance-missing', 'Danh sách chưa tham gia BHYT'], ['health-insurance-expiring', 'Danh sách BHYT sắp hết hạn (30 ngày)'], ['health-insurance-expired', 'Danh sách BHYT đã hết hạn'], ['health-insurance-household', 'Thống kê BHYT theo hộ'], ['health-insurance-area', 'Thống kê BHYT theo khu vực'], ['temporary_residence', 'Danh sach tam tru'], ['temporary_absence', 'Danh sach tam vang'], ['children', 'Danh sach tre em'], ['elderly', 'Danh sach nguoi cao tuoi'], ['labor', 'Danh sach lao dong'], ['party_member', 'Danh sach Dang vien'], ['youth_union', 'Danh sach Doan vien'], ['poor-households', 'Danh sach ho ngheo'], ['near-poor-households', 'Danh sach ho can ngheo'], ['age', 'Thong ke theo do tuoi'], ['gender', 'Thong ke theo gioi tinh']
    ];
  ...
  function renderBi(data) {
    ...
    const cards = [
      ['Cơ cấu dân số', charts.population], ['BHYT', charts.healthInsurance], ['Độ tuổi', charts.age], ['Ngh? nghi?p', charts.occupation], ['Lao ??ng', charts.labor], ['H? ngh?o/c?n ngh?o', charts.poverty], ['Bi?n ??ng theo th?ng', charts.monthlyMovements]
    ];
