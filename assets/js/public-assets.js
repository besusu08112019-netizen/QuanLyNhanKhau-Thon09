(function () {
  ...
  async function loadInventory(assetId, hostSelector = null) {
    ...
    state.inventoryItems = data.items || [];
    if (hostSelector) {
      renderInventory(data, hostSelector);
      return;
    }
    renderInventory(data, '#publicAssetInventoryPanel');
    renderInventory(data, '#publicAssetFormInventoryPanel');
  }

  function renderInventory(data = {}, hostSelector = '#publicAssetInventoryPanel') {
