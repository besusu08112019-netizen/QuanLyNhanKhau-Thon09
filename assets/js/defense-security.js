(() => {
  ...
  async function loadDashboard() {
    ...
    $('#defenseSecurityDashboard').innerHTML = KPI_GROUPS.map(group => '<section class="defense-kpi-group"><h3>' + esc(group.title) + '</h3><div class="defense-kpi-row">' + group.items.map(item => {
