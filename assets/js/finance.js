(function () {
  ...
  function shell() {
    ...
    host.innerHTML = [
      '<section id="financeDashboard" class="agri-kpi-grid" aria-label="Thống kê thu chi"></section>',
  ...
  function renderDashboard(data = {}) {
    ...
    const cards = [['Tổng thu', 'fa-arrow-trend-up', m.total_income || 0, 'success'], ['Tổng chi', 'fa-arrow-trend-down', m.total_expense || 0, 'danger'], ['Chênh lệch', 'fa-scale-balanced', m.balance || 0, Number(m.balance || 0) >= 0 ? 'primary' : 'warning'], ['Số phiếu', 'fa-receipt', m.total || 0, 'secondary']];
