(function (window, document) {
  ...
  function createMenuRenderer(menuRegistry, moduleRegistry, menuService) {
    ...
    function renderSection(menu) {
      ...
      var storageKey = 'thon09_sidebar_group_' + menu.key;
      var storedOpen = null;
      try {
        storedOpen = window.localStorage ? window.localStorage.getItem(storageKey) : null;
      } catch (error) {}
      var isOpen = storedOpen === null ? menu.key === 'dashboard' : storedOpen === '1';
