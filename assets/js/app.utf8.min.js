...
if (label.includes('ho va ten') || label.includes('ho ten') || label.includes('chu ho') || label.includes('chu su dung') || label.includes('nguoi san xuat') || label.includes('chu so huu') || label.includes('ten cong trinh') || label.includes('ten co so') || label.includes('dot thu') || label.includes('khoan thu') || label.includes('ten tai san')) return 'name';
if (label === 'ma ho' || label.includes('ma ho')) return 'household-code';
if (label.includes('ma nhan khau')) return 'person-code';
if (label.includes('ma cong trinh')) return 'asset-code';
if (label.includes('ma thua')) return 'parcel-code';
if (label.includes('bien so') || label.includes('bien kiem soat')) return 'license-plate';
if (label.includes('ma phuong tien')) return 'vehicle-code';
...
if (label.includes('khu vuc') || label.includes('khu dong')) return 'area';
if (label.includes('dien tich')) return 'area-size';
if (label.includes('o nha')) return 'at-home';
if (label.includes('di vang') || label.includes('chua nop')) return 'away';
if (label.includes('so luong') || label.includes('ho da nop') || label.includes('da thu') || label.includes('phai thu')) return 'metric';
if (label.includes('dien ho')) return 'household-type';
if (label.includes('loai') || label.includes('loai hinh') || label.includes('loai vat nuoi')) return 'type';
if (label.includes('tinh trang') || label.includes('trang thai') || label.includes('status')) return 'status';
return label.replace(/[^a-z0-9]+/g, '-').replace(/^-|-$/g, '') || 'field';
}
function isMobileCardTitleLabel(label, index) {
return ['chu ho', 'ho va ten', 'ho ten', 'chu su dung', 'nguoi san xuat', 'chu so huu', 'ten cong trinh', 'ten co so', 'dot thu', 'khoan thu', 'ten dang nhap', 'username', 'nguoi dung', 'tieu de', 'ten file', 'file', 'chi tieu'].some(key => label.includes(key));
}
function isMobileCardMetaLabel(label) {
return ['ma ho', 'ma nhan khau', 'ma cong trinh', 'ma thua', 'ma phuong tien', 'bien so', 'bien kiem soat', 'cccd', 'so dinh danh'].some(key => label.includes(key));
}
function isMobileCardHeaderMetaLabel(label) {
return ['ma ho', 'ma nhan khau', 'ma cong trinh', 'ma thua', 'ma phuong tien', 'bien so', 'bien kiem soat', 'username', 'ten dang nhap'].some(key => label.includes(key));
}
function isMobileCardAddressLabel(label) {
return ['dia chi', 'khu vuc', 'khu dong'].some(key => label.includes(key));
}
function isMobileCardStatLabel(label) {
return ['o nha', 'di vang', 'so nhan khau', 'tong so', 'so luong', 'dien tich', 'ho da nop', 'chua nop', 'phai thu', 'da thu'].some(key => label.includes(key));
}
function isMobileCardBadgeLabel(label) {
return ['dien ho', 'trang thai', 'tinh trang', 'dang vien', 'cu tru', 'vai tro', 'status', 'loai hinh', 'loai vat nuoi', 'loai'].some(key => label.includes(key));
}
...
const mobileFilterQuery = window.matchMedia ? window.matchMedia('(max-width: 1023px)') : null;
