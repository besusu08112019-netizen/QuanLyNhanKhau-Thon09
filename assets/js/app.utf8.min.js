...
addMarkersToLayer(layer, markers) {
if (!layer) return;
if (typeof layer.clearLayers === 'function') layer.clearLayers();
if (typeof layer.addLayers === 'function') layer.addLayers(markers);
else if (typeof layer.addLayer === 'function') markers.forEach(marker => layer.addLayer(marker));
}
render() {
...
if (typeof this.group.clearLayers === 'function') this.group.clearLayers();
if (typeof this.flatGroup.clearLayers === 'function') this.flatGroup.clearLayers();
...
if (this.map?.hasLayer?.(this.group) && typeof this.map.removeLayer === 'function') this.map.removeLayer(this.group);
if (typeof this.group.clearLayers === 'function') this.group.clearLayers();
this.addMarkersToLayer(this.flatGroup, list);
...
if (this.map?.hasLayer?.(this.flatGroup) && typeof this.map.removeLayer === 'function') this.map.removeLayer(this.flatGroup);
if (typeof this.flatGroup.clearLayers === 'function') this.flatGroup.clearLayers();
this.addMarkersToLayer(this.group, list);
...
const markerElement = cached.marker.getElement?.();
