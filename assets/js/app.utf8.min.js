...
return { useCluster, visibleMode, markerCount: markersById.size, flatLayerCount: typeof flatGroup.getLayers === 'function' ? flatGroup.getLayers().length : 0, clusterLayerCount: typeof group.getLayers === 'function' ? group.getLayers().length : 0, coordinateBucketCount: coordinateBuckets.size, duplicateCoordinateBuckets: duplicateBuckets.length, listenerCount: clusterListenerCount, markerLoadCycles, options: group?.options || {} };
}
};
}
