...
if (role === 'VIEWER') return ['dashboard','household','household_business','agricultural_land','agriculture','livestock','work_tasks','work_calendar','houses','citizen','report','gis'].includes(module) && action === 'read';
...
if (role === 'OFFICER') return (module === 'agricultural_land' && action === 'read') || (['dashboard','household','household_business','agriculture','livestock','work_tasks','work_calendar','houses','citizen','movement','report'].includes(module) && ['read','create','update','upload'].includes(action)) || (module === 'gis' && action === 'read');
return false;
}
