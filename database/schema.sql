...
CREATE TABLE IF NOT EXISTS `villages` (
  ...
  `status` ENUM('ACTIVE','INACTIVE','CREATING','READY','FAILED','DISABLED','MAINTENANCE') NOT NULL DEFAULT 'ACTIVE',
...
CREATE TABLE IF NOT EXISTS `citizens` (
  ...
  `chemical_warfare_victim` TINYINT(1) NOT NULL DEFAULT 0,
  `imprisoned_resistance_activist` TINYINT(1) NOT NULL DEFAULT 0,
  `youth_volunteer` TINYINT(1) NOT NULL DEFAULT 0,
  `resistance_hero` TINYINT(1) NOT NULL DEFAULT 0,
  `revolutionary_activist` TINYINT(1) NOT NULL DEFAULT 0,
