...
<head>
  ...
  <link rel="stylesheet" href="assets/css/app.css?v=20260630-person-detail-dynamic-1">
</head>
<body>
    ...
    <section class="main-area">
      ...
      <section id="personsScreen" class="screen person-management-screen">
        ...
        <div class="content-card person-list-card">
          ...
          <div class="table-responsive person-table-wrap"><table class="table person-table align-middle mb-0"><thead><tr><th><input type="checkbox" id="personCheckAll"></th><th>Mã hộ</th><th>Mã nhân khẩu</th><th>Họ và tên</th><th>Ngày sinh</th><th>Giới tính</th><th>CCCD/Số định danh</th><th>Cư trú</th><th>Đảng viên</th><th class="text-end">Thao tác</th></tr></thead><tbody id="personRows"></tbody></table></div>
  ...
  <script src="assets/js/app.js?v=20260630-person-detail-dynamic-1"></script>
  ...
  <script src="assets/js/import.js?v=20260630-import-template-1"></script>
  ...
  <script src="assets/js/sprint8.js?v=20260630-import-template-1"></script>
  <script src="assets/js/sprint9.js?v=20260630-import-template-1"></script>
