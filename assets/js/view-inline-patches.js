...
var popup=window.Thon09Print.render({
  title: printData.title||report.title||'B?o c?o',
  type: reportType(),
  paperSize: 'A4',
...
if(!popup)showMessage('Tr?nh duy?t ?ang ch?n c?a s? in. Vui l?ng cho ph?p popup.','warning');
}catch(e){showMessage(e.message||'Kh?ng in ???c b?o c?o.','danger');}
}
