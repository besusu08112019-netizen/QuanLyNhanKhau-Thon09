(function () {
  ...
  function runPopupAction(action, row, event) {
    ...
    if (action === 'phone') {
      const phone = event && event.currentTarget ? event.currentTarget.dataset.phone : '';
  ...
  function popupHtml(row) {
    ...
    return '<div class="gis-household-popup gis-smart-popup">' +
      ...
      '<div class="gis-smart-popup-actions">' +
        ...
        (phone ? '<a class="btn btn-sm btn-outline-primary" href="tel:' + escapeHtml(phone) + '" data-gis-popup-action="phone" data-phone="' + escapeHtml(phone) + '"><i class="fa-solid fa-phone"></i> Gọi điện</a>' : '') +
