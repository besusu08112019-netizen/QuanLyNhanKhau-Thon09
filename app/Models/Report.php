...
final class Report extends BaseModel
{
    public function build(string $type, array $filters = []): array
    {
        return match ($type) {
            ...
            'party-members', 'party_members', 'party_member', 'dang-vien' => $this->flagCitizenReport('Báo cáo Đảng viên', 'party_member', 'Đảng viên', $filters),
            ...
            'disabled-people', 'disabled', 'disabled_person', 'nguoi-khuyet-tat' => $this->flagCitizenReport('Báo cáo Người khuyết tật', 'disabled_person', 'Người khuyết tật', $filters),
