...
return [
    ...
    'alerts' => [
        'age_70' => [
            'label' => 'Đủ ' . \App\Policies\InsurancePolicy::DEFAULT_AGE . ' tuổi',
        ...
        'upcoming_70' => [
            'label' => 'Sắp đủ ' . \App\Policies\InsurancePolicy::DEFAULT_AGE . ' tuổi',
            'age' => \App\Policies\InsurancePolicy::DEFAULT_AGE,
            'type' => 'upcoming',
            'purpose' => 'Sắp đến tuổi rà soát BHYT',
            'message' => 'Có %d người sẽ đủ ' . \App\Policies\InsurancePolicy::DEFAULT_AGE . ' tuổi trong vòng ' . \App\Policies\AgePolicy::UPCOMING_POLICY_LOOKAHEAD_DAYS . ' ngày.',
        ],
        'upcoming_75' => [
