...
if (role === 'VIEWER') return ['dashboard','household','household_business','agriculture','livestock','work_tasks','work_calendar','houses','citizen','report','gis'].includes(module) && action === 'read';
...
if (role === 'OFFICER') return (['dashboard','household','household_business','agriculture','livestock','work_tasks','work_calendar','houses','citizen','movement','report'].includes(module) && ['read','create','update','upload'].includes(action)) || (module === 'gis' && action === 'read');
return false;
}
