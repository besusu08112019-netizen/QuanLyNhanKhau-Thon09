...
final class DefenseSecurityController extends BaseController
{
    ...
    public function nvqsShow(string $id): void { $this->showRecord($this->defense->findNvqs((int) $id), 'Không tìm thấy hồ sơ NVQS'); }
    ...
    public function militiaShow(string $id): void { $this->showRecord($this->defense->findMilitia((int) $id), 'Không tìm thấy hồ sơ dân quân'); }
    ...
    public function securityForceShow(string $id): void { $this->showRecord($this->defense->findSecurityForce((int) $id), 'Không tìm thấy hồ sơ ANTT cơ sở'); }
