(() => {
  ...
  function renderImportResult(data, processed) {
    ...
    const download = latestImportErrors.length ? '<button id="importErrorDownload" class="btn btn-outline-danger btn-sm mt-3" type="button" data-platform-action="import.errors.download"><i class="fa-solid fa-download"></i> Tải file lỗi CSV</button>' : '';
